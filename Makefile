...
.PHONY: help install dev dev-backend build test test-e2e check docker-build up up-detached down logs health
...
check: test build test-e2e ## Run all non-containerized verification
